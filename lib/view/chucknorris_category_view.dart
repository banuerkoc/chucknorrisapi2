...
import 'package:chucknorrisapi2/block/chucknorris_category_block.dart';
import 'package:chucknorrisapi2/networking/Repsonse.dart';
import 'package:chucknorrisapi2/model/chucknorris_category.dart';
import 'package:chucknorrisapi2/view/chucknorris_joke_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Chuck Norristen Seçmeler',
            style: TextStyle(color: Colors.white, fontSize: 20)),
        backgroundColor: Color(0xFFCCB485),
      ),
